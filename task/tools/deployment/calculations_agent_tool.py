...
class CalculationsAgentTool(BaseAgentTool):
    ...
    def description(self) -> str:
        return "Agent that can performs calculations, Python code with Python Code Interpreter tool, generate chart bars"
        ...
        return {
            ...
            "properties": {
                ...
                "propagate_history": {
                    ...
                    "description": (
                        """
                        To to include previous conversation history between the current agent and Calculations Agent
